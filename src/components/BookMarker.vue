...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                this.$http.post('https://vue-resource-tutorial-e50c2.firebaseio.com/users/' + this.user.uid + '/books.json', this.book)
                .then(response => {         
            ...
            fetchData() {
                this.$http.get('https://vue-resource-tutorial-e50c2.firebaseio.com/users/' + this.user.uid + '/books.json')
                .then(response => {
            ...
            deleteData(key){
                this.$http.delete('https://vue-resource-tutorial-e50c2.firebaseio.com/users/' + this.user.uid + '/books/' + key + '.json')
                .then(response => {
                    this.fetchData();
                    console.log(response);           
                },error => {               
